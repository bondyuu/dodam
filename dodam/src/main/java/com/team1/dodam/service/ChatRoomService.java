...
//        return opsHashChatRoom.values(CHAT_ROOMS);
        ...
        List<ChatRoomListResponseDto> chatRoomList = chatRoomList1.stream()
                                                                  .map(chatRoom -> ChatRoomListResponseDto.builder()
                                                                                                          ...
                                                                                                          .lastMessage((chatMessageRepository.findTopByChatRoom(chatRoom,Sort.by(Sort.Direction.DESC,"createdAt")) == null? "":chatMessageRepository.findTopByChatRoom(chatRoom,Sort.by(Sort.Direction.DESC,"createdAt")).getMessage()))
                                                                                                          .lastTime((chatMessageRepository.findTopByChatRoom(chatRoom,Sort.by(Sort.Direction.DESC,"createdAt")) == null? "":chatMessageRepository.findTopByChatRoom(chatRoom,Sort.by(Sort.Direction.DESC,"createdAt")).getCreatedAt().toString()))
